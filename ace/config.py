...
# Store full-text of article? Note: if this is disabled, filtering of studies
# for inclusion of certain text strings (e.g., 'fMRI') may fail.
SAVE_ARTICLE_FULLTEXT = True
